...
const Home = () => {
  return (
    <>   
      <section id='home'>
        <div className="container-fluid py-5" style={{backgroundColor:'#F2F2F2 ',marginTop:'90px',zIndex: '-1 '}} >
          <div className="row aligns-items-center" >
            ...
            <div className="  col-md-6  text-center aos-init aos-animated" data-aos="zoom-out">
               <img src="images/hero-img.png"  className="img-fluid foodImage " alt="Delicious Food" style={{Height: '490px', width: '100%', objectFit: 'cover'}}/>
            </div>
          </div>
        </div>
      </section>
