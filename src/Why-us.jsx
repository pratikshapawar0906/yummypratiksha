               ...
               <div className="row" >
                   <div className="col-lg-4 col-md-12 aos-init aos-animated" data-aos="fade-up" data-aos-delay="100" style={{marginTop:'24px'}}>
                       <div className="why-box">
                           ...
                           <div className="text-center"><a href="#" className="more-btn" style={{padding: '8px 40px 10px', backgroundColor:'rgb(234, 46, 46)', textDecoration: 'none', color: '#ffffff'}}><span>learn More</span><i className="bi bi-chevron-right ms-2"></i></a></div>
                       </div>
                   </div>
